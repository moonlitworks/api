...
import { getProjectsByCategory } from "../../../src/operations/projects/get-projects-by-category"
...
describe("getProjects", () => {
  ...
  it("should return 200 status code and call res.json", async () => {
    ...
    const req = { params: { category: "test-category"} }
    await getProjectsByCategory(req as any, res as any, {} as any)
